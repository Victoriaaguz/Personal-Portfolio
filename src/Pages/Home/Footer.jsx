  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo-png.png" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            {/* FaceBook */}
              <a
                href="https://www.facebook.com/profile.php?id=100007521935157"
            ...
            <li>
              {/* Instagram */}
              <a
                href="https://www.instagram.com/v_vampire19/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              {/* Linkedin */}
              <a
                href="https://www.linkedin.com/in/victoria-guzman-link-now/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Victoria 💖</p>
        <div className="footer--social--icon">
          <ul>
          </ul>
        </div>
